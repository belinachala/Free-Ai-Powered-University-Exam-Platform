...
const UniversityStudentHeader: React.FC<HeaderProps> = ({ onToggleSidebar }) => {
  ...
  const goToProfile = () => {
    setDropdownOpen(false);
    navigate("/uni-student/profile");
  };

  const goToSettings = () => {
    setDropdownOpen(false);
    navigate("/uni-student/settings");
  };
...
export default UniversityStudentHeader;
